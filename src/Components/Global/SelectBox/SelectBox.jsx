...
const SelectBox = ({ selected, setSelected, tabClassName, children }) => {
    ...
    return (
        <div
            ...
            className={"relative"} >
            <div className={"flex items-center gap-4 bg-light-primary-500 dark:bg-dark-primary-500 rounded-xl py-2 px-3"}>
            ...
            <AnimatePresence mode='wait'>
                {opened && (
                    ...
                    className="
                        ...
                        bg-light-primary-500 dark:bg-dark-primary-500 rounded-xl shadow-lg
