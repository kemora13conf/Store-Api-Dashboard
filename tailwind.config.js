  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'scaled': '300px 1px 3px 0 rgb(0 0 0 / 0.1), 300px 1px 2px -1px rgb(0 0 0 / 0.1)',
        ...
        'corner-light': '-1px -1px rgb(0 0 0 / 0.12), -5px -5px white',
        'corner-dark': '-1px -1px rgb(0 0 0 / 0.12), -5px -5px #100f1b',
      },
      fontFamily: {
